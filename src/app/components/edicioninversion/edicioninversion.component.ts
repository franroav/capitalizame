...
@Component({
  selector: 'app-edicioninversion',
  templateUrl: './edicioninversion.component.html',
  styleUrls: ['./edicioninversion.component.css'],
})
export class EdicioninversionComponent implements OnInit, DoCheck, OnDestroy {
  public ilustrations;
  public title: string;
  public windowSize;
