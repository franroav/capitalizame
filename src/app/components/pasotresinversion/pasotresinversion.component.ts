...
@Component({
  selector: 'app-pasotresinversion',
  templateUrl: './pasotresinversion.component.html',
  styleUrls: ['./pasotresinversion.component.css'],
})
export class PasotresinversionComponent implements OnInit, DoCheck, OnDestroy {
  public ilustrations;
  public title: string;
  public windowSize;
