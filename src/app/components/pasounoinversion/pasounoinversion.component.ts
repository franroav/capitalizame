...
@Component({
  selector: 'app-pasounoinversion',
  templateUrl: './pasounoinversion.component.html',
  styleUrls: ['./pasounoinversion.component.css'],
})
export class PasounoinversionComponent implements OnInit, DoCheck, OnDestroy {
  public ilustrations;
  public title: string;
  public windowSize;
